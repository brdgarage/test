        ...
        <script type="text/javascript"><!--
	        $(document).ready(function($){
	            ...
	            $('#customerAutocomplte').autocomplete({
	                source:'suggest_name.php?clienttype=private', 
	                minLength:2,
        ...
        <div id="wrapper">
            <div class="fullWidth header">
	            <nav>  
		          <ul class="menu">
		              ...
		              <!--li><a href="corparate.php">corparate</a></li-->
            ...
            <div class="leftCol">
                <div id="customers" class="MainTable">
                    <h4>Customers</h4>
                    <a href="newCustomer.php?iframe=true&width=500&height=500" rel="prettyPhoto[iframes]" target="_blank">New Customer</a>
                    <form method="post">
